...
from ayrton.parser.pyparser.pylexer import *
from ayrton.parser.pyparser.automata import NonGreedyDFA, DFA, DEFAULT
...
def makePyPseudoDFA ():
    ...
    # Names
    name = chain(states,
                 groupStr(states, string.ascii_letters + "_" + NON_ASCII),
...
def main ():
    ...
    print
    print("from ayrton.parser.pyparser import automata")
